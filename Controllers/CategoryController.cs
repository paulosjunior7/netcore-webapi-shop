...
public class CategoryController : ControllerBase
{
        ...
        [FromServices] DataContext context)
    {
        ...
        {
            return BadRequest(new { messagem = "Não foi possível criar a categoria" });
        }
    }
     ...
     )
    {
        ...
        {
            return BadRequest(new { messagem = "Não foi possível atualizar a categoria" });
        }
    }
    ...
    )
    {
        ...
        {
            return BadRequest(new { messagem = "Não foi possível remover a categoria" });
        }
    }
}